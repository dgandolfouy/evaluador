...
export const RangeSlider: React.FC<RangeSliderProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="w-full px-2">
      ...
      <div className="relative w-full h-1.5 bg-slate-800 rounded-full shadow-inner border border-white/5">
        ...
        <div 
          className="absolute top-1/2 -translate-y-1/2 h-6 w-6 bg-slate-900 shadow-[0_0_15px_rgba(0,0,0,0.5)] border-2 border-orange-500 rounded-full transition-all duration-150 pointer-events-none transform -translate-x-1/2 flex items-center justify-center z-20"
