...
export const A4Report = ({ employee, criteria, analysis, date, evaluatorName, className = "" }: any) => {
  return (
    <div id="printable-report" className={`hoja-a4-rr bg-white text-black p-10 w-[210mm] min-w-[210mm] ${className}`}>
